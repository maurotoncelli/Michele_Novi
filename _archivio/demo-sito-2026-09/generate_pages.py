...
<head>
        ...
        tailwind.config = {
            theme: {
                extend: {
                    colors: {
                        medical: {
                            bg: '#FFFFFF', surface: '#F8F9FA', border: '#EAEAEA',
                            text: '#111111', muted: '#6B7280', accent: '#006775',
                        }
                    },
                    fontFamily: {
    ...
    <style>
        ...
        .btn-mag:hover { color: #fff; }
        .btn-mag:hover::after { height: 100%; }
        ...
        .page-view.active-view { display: block; animation: viewEnter 0.8s var(--ease-varco) forwards; }
        @keyframes viewEnter { 0% { opacity: 0; transform: translateY(30px); } 100% { opacity: 1; transform: translateY(0); } }
    ...
    <header class="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-medical-border transition-transform duration-500" id="main-header">
        <div class="max-w-[80rem] mx-auto px-6 h-20 flex justify-between items-center">
            ...
            <nav class="hidden lg:flex items-center gap-10 text-[11px] font-mono uppercase tracking-widest text-medical-text">
                <a href="#chi-sono" class="nav-link py-2">Chi sono</a>
                <a href="#patologie" class="nav-link py-2">Cosa curo</a>
                <a href="#sedi" class="nav-link py-2">Dove ricevo</a>
                <a href="#note-cliniche" class="nav-link py-2">Note Cliniche</a>
            </nav>
            <div class="hidden sm:flex items-center gap-4">
                <a href="#contatti" class="btn-mag-solid px-6 py-2.5 rounded-full text-[11px] font-mono uppercase tracking-widest transition-all">Chiama</a>
            </div>
        </div>
    </header>
...
html_home = """
        ...
        <section id="view-home" class="page-view active-view">
            <div class="relative min-h-[calc(100vh-5rem)] flex flex-col justify-center px-6 max-w-[80rem] mx-auto pt-10 pb-20">
                <div class="grid lg:grid-cols-12 gap-12 items-center h-full">
                    <div class="lg:col-span-7 z-10 space-y-8 observer-trigger">
                        <div class="mask-text">
                            <span class="mask-text-inner text-[10px] font-mono uppercase tracking-widest text-medical-text border border-medical-border px-3 py-1 rounded-full">Ospedale CESAT Fucecchio · Studi in Toscana</span>
                        </div>
            ...
            <!-- TEASER: PATOLOGIE, SEDI, QUADERNO (Abbreviati per spazio) -->
            <div class="py-20 text-center">
                <a href="#patologie" class="accent-line text-[11px] font-mono uppercase tracking-widest pb-1 mx-4">Vai a Cosa Curo</a>
                <a href="#sedi" class="accent-line text-[11px] font-mono uppercase tracking-widest pb-1 mx-4">Vai a Dove Ricevo</a>
                <a href="#chi-sono" class="accent-line text-[11px] font-mono uppercase tracking-widest pb-1 mx-4">Vai a Chi Sono</a>
            </div>
        </section>
"""

html_chi_sono = """
        <!-- CHI SONO (Detailed from CV) -->
                ...
                <div class="lg:col-span-8 space-y-16">
                    <div class="reveal-fade d-1">
                        ...
                        <div class="text-lg font-light leading-relaxed text-medical-text space-y-6">
                            <p>Sono un chirurgo ortopedico e traumatologo specializzato esclusivamente nella patologia della spalla e dell'arto superiore. La mia pratica clinica si divide tra l'attività ambulatoriale sul territorio e la chirurgia di alto volume presso il CESAT (Centro di Eccellenza per la Sostituzione Articolare) dell'Ospedale San Pietro Igneo di Fucecchio.</p>
                        ...
                        <div class="space-y-8">
                            <div class="grid md:grid-cols-4 gap-4">
                                ...
                                <div class="md:col-span-3">
                                    <h4 class="text-lg font-serif text-medical-text">Chirurgo Ortopedico</h4>
                                    <p class="text-sm font-light text-medical-muted mt-1">CESAT – Ospedale San Pietro Igneo, Fucecchio.</p>
                                </div>
                            </div>
                            <div class="grid md:grid-cols-4 gap-4">
                                <div class="text-[10px] font-mono text-medical-muted">2020 — 2021</div>
                                <div class="md:col-span-3">
                                    <h4 class="text-lg font-serif text-medical-text">Research Fellow (Spalla e Arto Superiore)</h4>
                                    <p class="text-sm font-light text-medical-muted mt-1">UNIMORE / AOU Modena – Scuola Prof. Porcellini e Catani.</p>
                                </div>
                            </div>
                            <div class="grid md:grid-cols-4 gap-4">
                    ...
                    <div class="border-t border-medical-border pt-12 reveal-fade d-3">
                        ...
                        <ul class="space-y-4 text-sm font-light text-medical-text">
                            <li class="flex items-start gap-4">
                                <span class="text-medical-accent font-mono mt-1">→</span>
                                <div><strong>Charité, Berlino (2017)</strong> – Chirurgia spalla e gomito (Prof. Scheibel).</div>
                            </li>
                            <li class="flex items-start gap-4">
                                <span class="text-medical-accent font-mono mt-1">→</span>
                                <div><strong>University of Washington / Harborview, Seattle (2015)</strong> – Chirurgia mano e microchirurgia.</div>
                            </li>
                            <li class="flex items-start gap-4">
                                <span class="text-medical-accent font-mono mt-1">→</span>
                                <div><strong>RNOH Stanmore, Londra (2011)</strong> – Chirurgia del nervo periferico.</div>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <section id="view-patologie" class="page-view py-32 px-6 max-w-[80rem] mx-auto observer-trigger">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="#patologie/spalla" class="card-congruenza block border border-medical-border p-8 reveal-fade bg-white group">
                    ...
                    <p class="text-sm font-light text-medical-muted leading-relaxed">Cuffia dei rotatori, instabilità, lussazioni, protesica.</p>
                </a>
                <!-- Gomito e Mano -->
                <a href="#patologie/gomito-mano" class="card-congruenza block border border-medical-border p-8 reveal-fade d-1 bg-white group">
                    ...
                    <p class="text-sm font-light text-medical-muted leading-relaxed">Epicondilite, tunnel carpale, rizoartrosi, dita a scatto.</p>
                </a>
                <!-- Sport -->
                <a href="#patologie/sport" class="card-congruenza block border border-medical-border p-8 reveal-fade d-2 bg-white group">
                    ...
                    <p class="text-sm font-light text-medical-muted leading-relaxed">Lesioni legamentose, return to sport, lussazioni acromion-claveari.</p>
                </a>
                <!-- Metodi -->
                <a href="#patologie/artroscopia" class="card-congruenza block border border-medical-border p-8 reveal-fade bg-medical-surface group">
                    ...
                    <h3 class="text-2xl font-serif mb-3">Artroscopia</h3>
                    <p class="text-sm font-light text-medical-muted leading-relaxed">Il varco mini-invasivo e il rispetto biologico.</p>
                </a>
                <a href="#patologie/ecografia" class="card-congruenza block border border-medical-border p-8 reveal-fade d-1 bg-medical-surface group">
                    <span class="text-[10px] font-mono uppercase tracking-widest text-medical-accent mb-2 block">Metodo</span>
                    <h3 class="text-2xl font-serif mb-3">Ecografia MSK</h3>
                    <p class="text-sm font-light text-medical-muted leading-relaxed">Diagnostica e interventistica in ambulatorio.</p>
                </a>
            </div>
        </section>
"""
        ...
        <section id="view-contatti" class="page-view py-32 px-6 max-w-[80rem] mx-auto observer-trigger">
            <div class="grid lg:grid-cols-2 gap-16">
                ...
                <div class="border border-medical-border p-8 reveal-fade d-1 bg-medical-surface">
                    <form onsubmit="event.preventDefault(); document.getElementById('form-success').style.display='block';">
                    ...
                    <div id="form-success" class="hidden mt-6 text-sm font-light text-medical-accent border border-medical-accent p-4">Richiesta inoltrata. Verrai ricontattato.</div>
                </div>
            </div>
        </section>
"""
...
html_footer = """
    ...
    <script>
        ...
        document.querySelectorAll('.observer-trigger').forEach(trigger => scrollObserver.observe(trigger));

        const routes = {
            '': 'view-home', 'home': 'view-home', 'chi-sono': 'view-chi-sono',
            'patologie': 'view-patologie', 'sedi': 'view-sedi', 'contatti': 'view-contatti'
        };

        function navigate() {
            const rawHash = window.location.hash.replace('#', '').trim();
            // Handle sub-routes mapping to hubs if they don't have a specific view in this demo
            let targetViewId = routes[rawHash];
            if (!targetViewId) {
                if (rawHash.startsWith('patologie/')) targetViewId = 'view-patologie';
                else if (rawHash.startsWith('sedi/')) targetViewId = 'view-sedi';
                else if (rawHash.startsWith('note-cliniche')) targetViewId = 'view-home'; // Mock
                else targetViewId = 'view-home';
            }
...
full_html = html_head + html_home + html_chi_sono + html_patologie_hub + html_sedi_hub + html_contatti + html_footer
output_path = "/Volumes/Programs/Temporary files/Progetti cursor/Michele_Novi_Website/Proposte HTML/index.html"
with open(output_path, "w", encoding="utf-8") as f:
    f.write(full_html)

print("Pagine interne popolate con il contenuto reale.")
