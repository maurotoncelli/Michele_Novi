...
export async function FasciaContatto({ locale, titolo, lead }: { locale: Locale; titolo?: string; lead?: string }) {
  ...
  return (
    <section className="contenitore py-12 md:py-20" aria-labelledby="contatto-titolo">
      <Reveal className="grid gap-8 border-t border-linea pt-12 md:grid-cols-[1.2fr_1fr] md:items-end md:gap-16 md:pt-16">
        <div>
