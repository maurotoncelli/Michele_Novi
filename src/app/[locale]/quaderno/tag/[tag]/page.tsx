...
export default async function TagPage({ params }: PageProps<"/[locale]/quaderno/tag/[tag]">) {
  ...
  return (
    <>
      ...
      />
      <Briciole items={[{ label: m.meta.siteName, href: href(l, { kind: "home" }) }, { label: m.quaderno.titolo, href: href(l, { kind: "quaderno" }) }, { label: t }]} />
      <Intestazione eyebrow={m.quaderno.taggato} titolo={t} compatta />
